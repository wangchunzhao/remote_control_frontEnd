...
export const assetsTypeList = ({ projectId }) => {
  return fetch.get(BASE_URI + '/api/AssetsTypeProject/AssetsTypeList', {
    params: {
      projectId
    }
  })
...
export const fetchFilterAssetTypeOptions = ({ projectIdList, companyId }) => {
  return fetch.post(
    BASE_URI + '/api/AssetsTypeProject/AssetsListUser',
    projectIdList,
    {
      params: {
        companyId
...
export const fetchFilterLocationOption = ({ projectIdList, companyId }) => {
  return fetch.post(
    BASE_URI + '/api/AssetsTypeProject/AssetsLocationUser',
    projectIdList,
    {
      params: {
        companyId
...
export const fetchFilterSystemTypes = ({ projectIdList, companyId }) => {
  return fetch.post(
    BASE_URI + '/api/AssetsTypeProject/AssetsMonitorUser',
    projectIdList,
    {
      params: {
        companyId
...
export const fetchFilterDeviceTypes = ({ projectIdList, companyId }) => {
  return fetch.post(
    BASE_URI + '/api/AssetsTypeProject/AssetsDevTypeUser',
    projectIdList,
    {
      params: {
        companyId
...
export const assetsTypeCopy = (projectId, projectIdNew) => {
  return fetch.post(BASE_URI + '/api/AssetsTypeProject/AssetsTypeCopy', null, {
    params: {
      projectId,
      projectIdNew
    }
...
export const assetsTypeExport = form => {
  return fetch.post(
    BASE_URI + '/api/AssetsTypeProject/AssetsTypeExport',
    form,
    {
      headers: { 'Content-Type': 'application/json' }
    }
...
export const getCompanyAssetsTypeList = ({ companyId }) => {
  return fetch.get(
    BASE_URI + '/api/AssetsTypeProject/GetCompanyAssetsTypeList',
    {
      params: {
        companyId
      }
