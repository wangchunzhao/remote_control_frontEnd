...
export const getDeviceByMtid = (name, mtid, project) => {
  return fetch.get(`/api/DeviceInfo/getDeviceByMtid`, {
    params: {
      name,
      mtid,
      project
...
export const addRepairorder = query => {
  return fetch.post(`/api/Repair_order/AddRepair_order`, query)
}
...
export const getRepairOrderStatistics = () => {
  return fetch.get(
    `/api/Repair_Statistical_Analysis/GetRepair_Order_Statistics`
  )
}
...
export const getRepairCostStatistics = (starttime, endtime) => {
  return fetch.get(
    `/api/Repair_Statistical_Analysis/GetRepair_Cost_Statistics`,
    {
      params: {
        starttime,
        endtime
...
export const repairDelete = ID => {
  return fetch.get(`/api/Repair_order/Repair_Delete`, {
    params: {
      ID
    }
  })
...
export const repairDispatchingAcceptance = query => {
  return fetch.post(`/api/Repair_order/Repair_Dispatching_Acceptance`, query)
}
...
export const repairScheduleWebNew = repair_orderno => {
  return fetch.get(`/api/Repair_order/Repair_ScheduleWebNew`, {
    params: {
      repair_orderno
    }
  })
...
export const repairScheduleLogWebNew = repair_orderno => {
  return fetch.get(`/api/Repair_order/Repair_ScheduleLogWebNew`, {
    params: {
      repair_orderno
    }
  })
...
export const addRepairsparepart = query => {
  return fetch.post(`/api/Repair_order/AddRepair_sparepart`, query)
}

// 添加工具
export const addRepairtool = query => {
  return fetch.post(`/api/Repair_order/AddRepair_tool`, query)
}

// 修改备件
export const updateRepairspareparts = query => {
  return fetch.post(`/api/Repair_order/UpdateRepair_spareparts`, query)
}

// 修改工具
export const updateRepairtool = query => {
  return fetch.post(`/api/Repair_order/UpdateRepair_tool`, query)
}

// 删除备件
export const deleteRepairspareparts = ID => {
  return fetch.get(`/api/Repair_order/DeleteRepair_spareparts`, {
    params: {
      ID
    }
  })
...
export const getRepairProjectDevice = (modelid, projectid) => {
  return fetch.get(`/api/Repair_order/GetRepair_ProjectDevice`, {
    params: {
      modelid,
      projectid
    }
...
export const getBigInfofetch = () => {
  return fetch.get(`/api/DeviceInfo/getBigInfo`)
}

// 获取维保小类
export const getSmallInfofetch = bid => {
  return fetch.get(`/api/DeviceInfo/getSmallInfo`, {
    params: {
      bid
    }
  })
...
export const getRepairUser = companyid => {
  return fetch.get(`/api/Repair_order/GetRepair_User`, {
    params: {
      companyid
    }
  })
...
export const queryRepairorder = query => {
  return fetch.post(`/api/Repair_order/QueryRepair_order`, query)
}
...
export const getRepairStatisticalTimeList = time => {
  return fetch.get(
    `/api/Repair_Statistical_Analysis/GetRepair_Statistical_TimeList`,
    {
      params: {
        time
      }
...
export const repairStatus = query => {
  return fetch.post(`/api/Repair_order/Repair_Status`, query)
}

// 保存
export const addRepairprocessdetails = query => {
  return fetch.post(`/api/Repair_order/AddRepair_process_details`, query)
}

// 更新维修详情远程维修
export const updateRepairremote = query => {
  return fetch.post(`/api/Repair_order/UpdateRepair_remote`, query)
}

// 更新维修详情现场情况
export const updateRepairScene = query => {
  return fetch.post(`/api/Repair_order/UpdateRepair_Scene`, query)
}

// 更新维修详情过程
export const updateRepairprocess = query => {
  return fetch.post(`/api/Repair_order/UpdateRepair_process`, query)
}

// 更新维修结果
export const updateRepairresult = query => {
  return fetch.post(`/api/Repair_order/UpdateRepair_result`, query)
}

// 更换备件存草稿/保存
export const updateRepairsparepart = query => {
  return fetch.post(`/api/Repair_order/UpdateRepair_sparepart`, query)
}

// 点击更新按钮执行记录更新
export const updateRepairreplacesparepart = query => {
  return fetch.post(`/api/Repair_order/UpdateRepair_replace_sparepart`, query)
}

// 点击删除按钮执行删除操作
export const deleteRepairreplacesparepart = ID => {
  return fetch.get(`/api/Repair_order/DeleteRepair_replace_sparepart`, {
    params: {
      ID
    }
  })
...
export const addRepairreplacesparepart = query => {
  return fetch.post(`/api/Repair_order/AddRepair_replace_sparepart`, query)
}
...
export const repairScheduleS = Repair_Orderno => {
  return fetch.get(`/api/Repair_order/Repair_ScheduleS`, {
    params: {
      Repair_Orderno
    }
  })
...
export const repairScheduleList = Repair_Orderno => {
  return fetch.get(`/api/Repair_order/Repair_ScheduleList`, {
    params: {
      Repair_Orderno
    }
  })
...
export const repairsceneList = Repair_Orderno => {
  return fetch.get(`/api/Repair_order/Repair_sceneList`, {
    params: {
      Repair_Orderno
    }
  })
...
export const repairremoteList = Repair_Orderno => {
  return fetch.get(`/api/Repair_order/Repair_remoteList`, {
    params: {
      Repair_Orderno
    }
  })
...
export const deleteRepairtool = id => {
  return fetch.get(`/api/Repair_order/DeleteRepair_tool?ID=${id}`)
}
// 维修单评价
export const repairEvaluate = query => {
  return fetch.post(`/api/Repair_order/Repair_Evaluate`, query)
...
export const repairreplacesparepartList = Repair_process_details_id => {
  return fetch.get(`/api/Repair_order/Repair_replace_sparepartList`, {
    params: {
...
export const deleteRepairuser = id => {
  return fetch.get(`/api/Maintenance_team/DeleteRepair_user`, {
    params: {
      id
    }
  })
...
export const updateRepairuser = query => {
  return fetch.post(`/api/Maintenance_team/UpdateRepair_user`, query)
}
...
export const userRepairList = id => {
  return fetch.get(`/api/Maintenance_team/User_RepairList`, {
    params: {
      id
    }
  })
...
export const getClassList = () => {
  return fetch.get(`/api/DeviceInfo/getClassList`)
}
