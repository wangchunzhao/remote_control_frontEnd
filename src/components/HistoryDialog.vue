...
export default {
  ...
  methods: {
    ...
    fetchChartSeries: debounce(function() {
      ...
      let { startTime, endTime, interval, pointIds, pointIdsByAdd } = this.form
      ...
      getHistoryData({
        ...
        pointIdList: [...pointIds, ...pointIdsByAdd],
        tmes: interval
      })
        .then(res => {
          if (
