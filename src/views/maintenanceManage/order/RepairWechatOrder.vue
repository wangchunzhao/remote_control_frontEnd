  ...
  <div class="repairIndex content-box">
      ...
      <el-table :data="data" highlight-current-row fit>
        ...
        <el-table-column label="操作" min-width="80">
          <template slot-scope="scope">
            ...
            <el-button
              v-show="
                scope.row.Status == 2 && userInfo.uid === scope.row.Repair_User
              "
              type="text"
              style="color:#7FB4EF;"
              @click="handleAccept(scope.row)"
            ...
            <el-button
              v-show="
                scope.row.Status == 3 && userInfo.uid === scope.row.Repair_User
              "
              type="text"
              style="color:#91cef4;"
    ...
    >
      ...
      <div slot="footer" class="dialog-footer" style="text-align: center;">
        <el-button type="primary" size="small" @click="submitDivision('formm')">
          提交
        </el-button>
      </div>
    </el-dialog>
    ...
    >
      <el-form
        ...
        label-position="left"
      >
        <el-form-item label="拒绝原因" label-width="100px" prop="repair_result">
          <el-select
    ...
    >
      <el-form ref="formrevoke" :model="formrevoke" label-position="left">
        <el-form-item label="撤销原因" label-width="80px" prop="repair_result">
          <el-select
