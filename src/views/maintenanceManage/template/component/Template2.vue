<template>
  <el-card class="pact-template2-card" shadow="never">
    ...
    <div style="margin-bottom: 15px;">
      <el-radio :disabled="true" v-model="radio1" label="1">是</el-radio>
    </div>
    <div style="margin-bottom: 15px;">
      <el-radio :disabled="true" v-model="radio1" label="1">否</el-radio>
    </div>
  </el-card>
</template>
