...
import {
  ...
  getMaintenanceColumnare,
  getModelBigList,
  getMaintenancePie,
  getMaintenanceStatisticalDetailList
...
export default {
  ...
  methods: {
    ...
    downloadExcel() {
      ...
      window.location = `${BASE_URI}/api/MaintenanceStatistical/ExportMaintenanceStatisticalDetailList?startDate=${this.filterForm.start}&endDate=${this.filterForm.end}&industry=${this.$store.state.app.company.industry}&companyId=${this.companyId}&projectName=${this.projectNameFilter}&userId=${this.$store.state.app.userInfo.uid}${query}`
    },
    fetchTableData() {
