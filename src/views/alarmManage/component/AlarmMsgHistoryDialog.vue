<template>
  <el-dialog
    ...
    @close="handleClose"
    custom-class="alarm-msg-history-dialog"
  >
    <el-tabs class="alarmMsgHistory-tabs_KSJF382" v-model="activeName">
...
<style lang="scss">
.alarmMsgHistory-tabs_KSJF382 {
  .el-tabs__nav-scroll {
    padding-left: 0;
  }
}
.alarm-msg-history-dialog {
  .el-dialog__body {
    padding: 0 24px;
  }
  .el-tabs__nav-scroll {
