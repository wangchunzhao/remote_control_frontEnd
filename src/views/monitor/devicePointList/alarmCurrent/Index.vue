<template>
  <div>
    ...
    >
      <el-table-column min-width="110" prop="PointName" label="点位名称" />
...
export default {
  ...
  methods: {
    ...
    showFilterNotice() {
      const { deviceTypes, alarmLevels, alarmTypes } = this.filterForm
      return !(deviceTypes.length || alarmLevels.length || alarmTypes.length)
    }
  }
}
</script>
